...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
static void signal_handler(const boost::system::error_code& error, opmip::pmip::maar& maar)
{
	log_(0, "quiting");
...
int main(int argc, char** argv)
{
	...
	try {
		...
		opmip::pmip::maar            maar(ios, ndb, addrconf, concurrency);
		...
		maar.start(opts.identifier.c_str(), opts.link_local_ip, opts.tunnel_global_address);


		sigs.async_wait(boost::bind(signal_handler, _1, boost::ref(maar)));
