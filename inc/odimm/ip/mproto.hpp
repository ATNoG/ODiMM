...
public:
	...
	enum types {
		...
		handoff_type   = 23,
		att_type       = 24,
		//TODO: change the type number
		// The numbers must be assinged by IANA
		smaar_type	   = 98,
		pmaar_type     = 99,
	};
	...
	struct smaar {
		static const uint8 type_value = 98;//to be assigned by IANA
		static const uint8 length = 16;
		boost::asio::ip::address_v6 smaar_addr;
	};

	struct pmaar {
		static const uint8 type_value = 99;//to be assigned by IANA
		static const  uint8 length = 34;
		uint8 prefix_length;
		boost::asio::ip::address_v6 pmaar_addr;
		boost::asio::ip::address_v6 home_net_addr;
	};
