...
///////////////////////////////////////////////////////////////////////////////
// tunnel management - create an ancillary data structure (maar_list) that stores 
// the previous MAAR's address and the corresponding prefix(es) assigned for the MN
class bcache_entry {
	friend class bcache;
